    ...
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BlogPostId,CommentBody")] Comment comment)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                //send user back to blogpost detail page
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BlogPostId,AuthorId,Created,Update,CommentBody,UpdateReason")] Comment comment)
        {
            if (ModelState.IsValid)
            {
